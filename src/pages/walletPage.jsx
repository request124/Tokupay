    ...
    return (
        <>
            ...
            <div className='pt-[120px] pb-[90px] flex juustify-center items-center flex-col'>
                ...
                <a href="/token"><button  className="flex px-[50px] py-[16px] bg-[#EF0606] text-white border rounded-lg text-[13px] font-medium shadow-sm text-black sm:hidden md:hidden lg:flex" type="button">Connect Wallet</button></a>
            </div>
            </>
    )
}
